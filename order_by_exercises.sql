...
ORDER BY first_name;
-- ANSWER: Irean Reutenauer is the first row and Vidya Simmen is in the last row
...
-- ANSWER: Irena Action is in the first row and Vidya Zweizig
...
-- ANSWER: Irena Action is in the first row and Vidya Zweizig. It looks like it's the same as 3!
...
ORDER BY emp_no;
-- ANSWER: 899 employees returned, First row 10021 Erde Ramzi , Last Row 499648 Erde Tadahiro
...
-- ANSWER: Total employees returned is 899, Newest employee is Eldridge Teiji and oldest employee is Erde Sergi
...
WHERE YEAR(hire_date) LIKE '199%'
		AND birth_date LIKE '%-12-25' -- Learned from MASON during review! Pretty cool
ORDER BY birth_date ASC, hire_date DESC;
-- ANSWER: 362 employee returned, Oldest/Last Hire Khun Bernini , Yougest/First Hire Douadi Pettis